...
export default function LoginPage() {
  ...
  if (checking) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-secondary via-gray-50 to-primary/10">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-sm border border-primary/20">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-primary hover:bg-primary-dark disabled:opacity-60 text-black font-semibold px-4 py-3 rounded-xl transition-colors shadow-sm hover:shadow-md"
          >
            {loading ? (
