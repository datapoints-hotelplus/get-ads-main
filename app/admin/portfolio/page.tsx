...
const METRICS = [
  ...
  { value: "cpm", label: "CPM" },
  { value: "ctr", label: "CTR (%)" },
  { value: "ctr_all", label: "CTR All (%)" },
  { value: "impressions", label: "Impressions" },
  { value: "clicks", label: "Clicks (Link)" },
  { value: "inline_link_clicks", label: "Inline Link Clicks" },
  { value: "unique_inline_link_clicks", label: "Unique Link Clicks" },
  ...
  { value: "cost_per_engagement", label: "Cost per Engagement" },
  ...
  { value: "post_reactions", label: "Post Reactions" },
  { value: "page_likes", label: "Page Likes" },
  { value: "video_views_3s", label: "Video Views 3s" },
  { value: "video_p25", label: "Video 25%" },
  { value: "video_p50", label: "Video 50%" },
  { value: "video_p75", label: "Video 75%" },
  { value: "video_p100", label: "Video 100%" },
  { value: "video_avg_time", label: "Avg Watch Time (s)" },
  { value: "hook_rate", label: "Hook Rate" },
  { value: "hold_rate", label: "Hold Rate" },
];
